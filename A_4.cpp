...
void Sets::Intersection()
{
    for(i=0;i<n;i++)
    {
        ...
        I.push_back(A_Bin[i]&B_Bin[i]);
    }
}
void Sets::getIntersection()
{
    cout<<endl<<"Bitwise AND Operation(A Intersection B)is:{ ";
    for(i=0; i<n; i++)
    {
        cout<<I[i]<<" ";
    }
